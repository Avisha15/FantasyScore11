...
export class AppOperation {
  ...
  constructor() {
    this.base_url = 'http://65.0.134.70:3000/';
    this.root_path = '';
  ...
  post(path: string, params: any, type: string = ADMIN_TYPE) {
    return this.send(path, 'POST', null, params, type);
  }

  patch(path: string, params: any, type: string = ADMIN_TYPE) {
    return this.send(path, 'PATCH', null, params, type);
  }

  put(path: string, params: any, type: string = ADMIN_TYPE) {
    return this.send(path, 'PUT', null, params, type);
  }

  get(path: string, params?: any, data?: any, type: string = ADMIN_TYPE) {
    return this.send(path, 'GET', params, data, type);
  }

  delete(path: string, params: any, type: string = ADMIN_TYPE) {
